...
1. **Read Architecture**: See `docs/architecture/ARCHITECTURE.md`
2. **Design Details**: See `docs/architecture/DESIGN_WALKTHROUGH.md`
3. **Create Custom Scripts**: See `scripts/example_scripts/`
4. **Train on Your Data**: Modify `train_synthetic_models.py`

## Support

- Check documentation in `docs/architecture/ARCHITECTURE.md`
