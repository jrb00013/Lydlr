...
from backend.api.views import (
    ...
    NodePreviewView, NodePreviewMjpegView, NodeTopicsView, NodePreviewLatestView,
    DemoPulseView, DemoAutopilotView,
...
urlpatterns = [
    ...
    path('nodes/<str:node_id>/preview/', NodePreviewView.as_view(), name='node-preview'),
    path('nodes/<str:node_id>/preview.mjpg', NodePreviewMjpegView.as_view(), name='node-preview-mjpeg'),
    path('nodes/<str:node_id>/preview.jpg', NodePreviewLatestView.as_view(), name='node-preview-latest'),
    path('nodes/<str:node_id>/topics/', NodeTopicsView.as_view(), name='node-topics'),
    path('demo/pulse/', DemoPulseView.as_view(), name='demo-pulse'),
    path('demo/status/', DemoAutopilotView.as_view(), name='demo-status'),
